...
public interface IAccountRepository extends JpaRepository<Account , Long> {
    ...
    public Account queryAccountCurrencyUSD(@Param("idUser") Long idUser , @Param("USD")CurrencyEnum usd);

    @Query("SELECT a FROM Account a WHERE a.userId = :idUser AND a.currency = :ARS")
    public Account queryAccountCurrencyARS(@Param("idUser") Long idUser , @Param("ARS")CurrencyEnum ars);
